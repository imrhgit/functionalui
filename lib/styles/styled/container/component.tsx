...
const Container: FC<DivProps> = ({
  ...
  if (borderBottomLeftRadius) {
    classes[BORDER_BOTTOM_LEFT_RADIUS_CLASSES[borderBottomLeftRadius]] = true;
  }
  if (borderBottomRightRadius) {
    classes[BORDER_BOTTOM_RIGHT_RADIUS_CLASSES[borderBottomRightRadius]] = true;
  }
  if (borderTopLeftRadius) {
    classes[BORDER_TOP_LEFT_RADIUS_CLASSES[borderTopLeftRadius]] = true;
  }
  if (borderTopRightRadius) {
    classes[BORDER_TOP_RIGHT_RADIUS_CLASSES[borderTopRightRadius]] = true;
  }
  if (borderStyle) {
