...
export const TOAST_TYPE: { [key: number]: ToastNotification } = {
  ...
  [ToastTypes.Info]: { icon: 'spinner', color: ColorPalettes.Grey7, isTimeout: true, default: 'Loading', classname: 'blue', },
  [ToastTypes.Static]: { icon: 'info', color: ColorPalettes.Blue5, isTimeout: false, default: 'Info', classname: 'blue', },
  [ToastTypes.Loading]: { icon: 'info', color: ColorPalettes.Blue5, isTimeout: false, default: 'Info', classname: 'blue', },
